...
"        }")
        ...
        self.contenedorSwitchColaboracion = QFrame(self.stackFicha_estuPage1)
        self.contenedorSwitchColaboracion.setObjectName(u"contenedorSwitchColaboracion")
        self.contenedorSwitchColaboracion.setGeometry(QRect(670, 270, 67, 41))
        self.contenedorSwitchColaboracion.setFrameShape(QFrame.Shape.StyledPanel)
        self.contenedorSwitchColaboracion.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_5 = QHBoxLayout(self.contenedorSwitchColaboracion)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.label_50 = QLabel(self.stackFicha_estuPage1)
        self.label_50.setObjectName(u"label_50")
        self.label_50.setGeometry(QRect(750, 269, 111, 41))
        self.label_50.setMinimumSize(QSize(0, 30))
        self.label_50.setMaximumSize(QSize(16777215, 50))
...
"}")
    ...
    def retranslateUi(self, ficha_estu):
        ...
        self.label_50.setText(QCoreApplication.translate("ficha_estu", u"Colaboraci\u00f3n de inscripci\u00f3n", None))
